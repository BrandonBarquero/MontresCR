<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Salida_Parte.aspx.cs" Inherits="Montres.Salida_Parte" %>
                        ...
                        <div class="panel-body">
                            <div class="form-horizontal"> 
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <asp:TextBox runat="server"  id="numero_parte" name="numero_parte" value="" type="text" class="form-control" required="" readonly=""/>
                                    </div>
                                ...
                                <div>
                                     <asp:Button ID="_guardar" Text="Retirar parte" runat="server" OnClick="Retirar_Parte" class="btn btn-outline-dark"  style="float: right;"/>
                                </div> 
                            </div> 
                        </div>
                    </div>
