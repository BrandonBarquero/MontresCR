<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Numero_Alternativo_Ventas.aspx.cs" Inherits="Montres.Numero_Alternativo_Ventas" %>
     ...
     <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                        <li><a  class="link-dark"href="List_Partes_Ventas.aspx">Lista de Partes</a></li>
